"""
main.py
LifeOS v8.7 — Application entry point.
...
def create_app() -> Flask:
    ...
    log.info("✅ LifeOS v8.7 — app created with %d blueprints", len(app.blueprints))
    return app
...
if __name__ == "__main__":
    ...
    log.info("🚀 LifeOS v8.7 starting on port %d (debug=%s)", port, debug)
